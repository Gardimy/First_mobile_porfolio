...
> In this project, I start to create my first mobile porfolio by a best practice.

**[mobile-porfolio]** is an application.
...
If you are new by coding, you can use my repository to start your first project mobile.

### Prerequisites

In order to run this project you need: To Follow me in github ,you will have more oppotunity to have access to my all new projects.
